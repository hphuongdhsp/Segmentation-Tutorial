...
## OPTIMIZATION LEARNING RATE SCHEDULE SETTING
# optimizer
...
# Model Architecture (dont't change this part)
# model settings
model = dict(
    # type of model
    type="MaskRCNN",
    # dict informations of backbone
    backbone=dict(
        type="ResNet",
        depth=50,
        num_stages=4,
